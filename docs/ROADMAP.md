...
| Metal | Direct MSL compilation/dispatch and same-device Q2/Q4 fused-matvec comparison against the scalar oracle on Apple M5 | Resident tensor ownership, embedding/token-mixer kernels, full graph, and roofline/reference benchmark |
