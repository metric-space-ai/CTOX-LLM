...
| Recovery data | 2,072 training and 524 held-out materialized samples; 15 language labels; ordinary chat, code, math/STEM, Agentic/tools, structured output, German, and genuine 32K/64K/128K; zero split/prior-calibration overlap; all payloads and Assistant targets verified | Apply the 16-family semantic domain gate and replenish gaps, then cache release-size sparse BF16/MTP teacher targets and run release-quality evaluation |
