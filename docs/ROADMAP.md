...
| CPU | Scalar Qwen oracle, mmap-bound recovered target+MTP decoder correctness graph, engine-owned greedy draft verification, and experimental packed AVX2/NEON Q2/Q4/mixed projections plus embedding gather | Production token-mixer kernels, chunked prefill, ISA expansion, full-artifact golden run, and roofline/reference benchmark |
